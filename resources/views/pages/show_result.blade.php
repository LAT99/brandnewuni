        ...
        <div class="col-lg-6" style="text-align: right">
            <div style="float: right" class="format-div-time-main">
                <div class="format-div-next  main-mini-footer">
                    ...
                    <div class="send-result hidden-question" type="button" style="cursor: default; background: none; border: none; color: #ffff"><span><a style="color: white" href="{{route('home')}}">HOÀN THÀNH</a></span></div>
                </div>
            </div>
        </div>
    </div>
