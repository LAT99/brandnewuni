                                            ...
                                            @csrf
                                                ...
                                                <div class="row-fluid hidden-class">
                                                    <div class="widget-content notify-ui" style="border-bottom: none">
                                                        <div class="control-group">
                                                            <div id="">
                                                                <img style="max-height: 500px; width: 100%; object-fit: contain" src="{{asset('images/news/')}}/{{$new->image}}" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui" style="border-bottom: none">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea name="content_short" style="width: 95%">@if($new->content_short){{$new->content_short}}@endif</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="content_detail" required style="width: 100%">{{$new->content_detail}}</textarea>
                                                        </div>
                                                    </div>
