                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container-fluid">
                                ...
                                <div class="span12">
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-content"> 
                                            <form action="{{route('management-gift-physical.create')}}" method="POST"  enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui" style="border-bottom: none; padding-bottom: 0px">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="span11" autocomplete="off" name="gift_name" style="width: 95%" required="" placeholder="Nhập tên quà tặng">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui" style="border-bottom: none; padding-bottom: 0px">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input id="uploadFile" required type="file" name="gift_image" class="img" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui" style="border-bottom: none; padding-bottom: 0px">
                                                        <div class="control-group">
                                                            ...
                                                            <input id="gift_qty" autocomplete="off" required type="number" name="gift_qty" class="img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="widget-content notify-ui" style="border-bottom: none; padding-bottom: 0px">
                                                        <div class="control-group">
                                                            ...
                                                            <input id="gift_score" autocomplete="off" required type="number" name="gift_score" class="img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="widget-content notify-ui" style="border-bottom: none">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls" style="margin-left: 65px;">
                                                                <input type="radio" name="status_gift" id="status_1" value= "1" checked style="margin-top: 0px !important;"/> <span style="font-size: 14px !important;">Hoạt động</span> <br/>
                                                                <input type="radio" name="status_gift" id="status_0" value="0" style="margin-top: 0px !important;"/> <span style="font-size: 14px !important;">Không hoạt động</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <button id="btn1" type="button" class="btn btn-primary" style="margin-top:20px"><a style="color: white" href="{{route('management-gift-physical.add')}}">Quay lại</a></button>
                            <hr>
                        </div>
                    </div>
                </div>
